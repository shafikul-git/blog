...
@section('otherConetent')
        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    <button onclick="mobileMenu()" data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar"
                        aria-controls="logo-sidebar" type="button"
                        class="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
                        <span class="sr-only">Open sidebar</span>
                        <i class="fa-solid fa-bars text-2xl font-bold dark:text-white cursor-pointer"></i>
                    </button>
                ...
                <div class="flex items-center">
                    <div class="flex items-center ms-3">
                        <div>
                            <button onclick="userMenu()" type="button"
                        ...
                        <div class="relative">
                            <div class="z-50 transition-all hidden userMenu top-[0.8rem] left-[-10.8rem] absolute my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                                id="dropdown-user">
    ...
    <aside id="logo-sidebar"
        class=" mobileMenuOpen -translate-x-full sm:translate-x-0 fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700"
        aria-label="Sidebar">
                        ...
                        <ul class="ml-3">
                            <li>
                                <a href="{{ route('menu.create') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                    ...
                                    <span class="flex-1 ms-3 whitespace-nowrap">View All</span>
                                </a>
                            </li>
                        </ul>
                    </a>
    ...
    <script>
        ...
        function mobileMenu() {
            ...
            if (loginIconToggle.classList.contains('-translate-x-full') && loginIconToggle.classList.contains(
                    'sm:translate-x-0')) {
                loginIconToggle.classList.remove('-translate-x-full');
                loginIconToggle.classList.remove('sm:translate-x-0');
            } else {
                loginIconToggle.classList.add('-translate-x-full');
                loginIconToggle.classList.add('sm:translate-x-0');
            }
        }
