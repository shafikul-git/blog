...
@foreach ($allMenuView as $menus)
    <ul>
        <li class="font-bold dark:text-white bg-gray-700 w-full py-3 my-6 hover:bg-gray-800 transition-all cursor-move rounded-md shadow-[0px_5px_10px_2px_#63b3ed]">
