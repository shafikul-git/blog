...
<div class="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 font-sans p-6 hover:shadow-[inset_0px_1px_21px_1px_#667eea] ">
    <div class="grid grid-cols-1 lg:grid-cols-3 lg:gap-8 gap-12 items-center md:max-w-7xl max-w-lg mx-auto">
      <div>
        <h2 class="text-4xl font-bold text-gray-700 dark:text-gray-300 uppercase mb-6">{{ $categorys->name }}</h2>
        <h2 class="text-3xl font-extrabold text-gray-900 dark:text-gray-100 uppercase leading-10">{{ $categorys->description }}</h2>
        <a href="" class="text-indigo-500 hover:text-indigo-600 text-xl font-bold hover:underline mt-4">See All</a>
      </div>
