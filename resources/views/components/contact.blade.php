<div
    ...
    <div class="p-8 bg-gray-900">
        <h2 class="text-3xl font-bold text-white">Get In <span class="text-yellow-400">Touch</span></h2>
        <p class="text-sm text-gray-300 mt-4 leading-relaxed">Have a specific inquiry or looking to explore new
            opportunities? Our
            experienced team is ready to engage with you.</p>
        @php
            $inputStyle =
                'px-2 py-3 bg-transparent text-gray-300 w-full text-sm border-b border-gray-400 focus:border-yellow-400 outline-none';
        @endphp
        <x-form action="{{ route('contact.store') }}" method="POST" :fields="[
            [
                'type' => 'text',
                'name' => 'name',
                'id' => 'name',
        ...
        {{-- <form>
            <div class="space-y-4 mt-8">
                ...
                <input type="text" placeholder="Street"
                    class="px-2 py-3 bg-transparent text-gray-300 w-full text-sm border-b border-gray-400 focus:border-yellow-400 outline-none" />
