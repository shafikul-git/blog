<div class="">
    <footer class="bg-gradient-to-r from-[#31135e] via-purple-800 to-[#31135e] py-12 px-10 font-sans tracking-wide">
        <div class="grid max-sm:grid-cols-1 max-lg:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h4 class="text-white text-lg mb-6">Use Cases</h4>
            <ul class="space-y-4">
              <li><a href="javascript:void(0)" class="text-gray-300 hover:text-white text-[15px]">Web designers</a>
              </li>
              <li><a href="javascript:void(0)" class="text-gray-300 hover:text-white text-[15px]">Marketers</a>
              </li>
              <li><a href="javascript:void(0)" class="text-gray-300 hover:text-white text-[15px]">Small
                business</a></li>
              <li><a href="javascript:void(0)" class="text-gray-300 hover:text-white text-[15px]">Themes</a></li>
              <li class="text-[15px]"><a href="javascript:void(0)" class="text-gray-300 hover:text-white text-[15px]">Website
                builter</a>
              </li>
            </ul>
          ...
          <div>
            <h4 class="text-white text-lg mb-6">Product</h4>
            <ul class="space-y-4">
              <li><a href="javascript:void(0)" class="text-gray-300 hover:text-white text-[15px]">Landing page</a>
              </li>
              <li><a href="javascript:void(0)" class="text-gray-300 hover:text-white text-[15px]">Popup builder</a>
              </li>
              <li><a href="javascript:void(0)" class="text-gray-300 hover:text-white text-[15px]">Web design</a>
              </li>
              <li class="text-[15px]"><a href="javascript:void(0)" class="text-gray-300 hover:text-white text-[15px]">Content</a></li>
            </ul>
          </div>
          ...
          <div>
            <h4 class="text-white text-lg mb-6">Company</h4>
            <ul class="space-y-4">
        ...
        <div class="grid max-md:grid-cols-1 md:grid-cols-2 items-center gap-8">
          <div>
            <div class="bg-white flex px-1 py-1 rounded-full text-left">
              ...
              <button type='button'
                class="bg-[#31135e] text-white text-[15px] rounded-full px-5 py-2 tracking-wide">Subscribe</button>
            </div>
          </div>
  
          <ul class="flex items-center flex-wrap gap-y-3 space-x-6 justify-end">
        ...
        <p class='text-gray-300 text-[15px] mt-6'>© 2023<a href='https://readymadeui.com/' target='_blank'
